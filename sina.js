...
const subCardBox = document.getElementById("subCard");
...
function selectSub(){
    ...
    document.getElementById("subRadio").checked=true;

    document.getElementById("otherRadio").checked=false;


    subCardBox.classList.add("active");
...
function selectOther(){
    ...
    document.getElementById("subRadio").checked=false;
    ...
    subCardBox.classList.remove("active");
...
function getFields(){
    ...
    if(isSub && !customTechnicalInput.disabled){
